...
var definitions = []Definition{
	...
	{ID: "badge-strip", CodecID: "badge-strip"},
	...
	{ID: "crlf-to-lf", CodecID: "crlf-to-lf"},
	...
	{ID: "doubled-words", CodecID: "doubled-words"},
	{ID: "edge-blanks", CodecID: "edge-blanks"},
	{ID: "empty-headings", CodecID: "empty-headings"},
	{ID: "epoch-to-iso", CodecID: "epoch-to-iso"},
	{ID: "frontmatter-strip", CodecID: "frontmatter-strip"},
	{ID: "header-norm", CodecID: "header-norm"},
	{ID: "hex-compact", CodecID: "hex-compact"},
	{ID: "horiz-rules", CodecID: "horiz-rules"},
	{ID: "html-comments", CodecID: "html-comments"},
	...
	{ID: "list-markers", CodecID: "list-markers"},
	...
	{ID: "setext-to-atx", CodecID: "setext-to-atx"},
	...
	{ID: "variation-sel", CodecID: "variation-sel"},
