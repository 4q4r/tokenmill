...
func TestDefinitionsUseRealCodecIDsAndExplicitAliases(t *testing.T) {
	wantCodecIDs := map[string]string{
		...
		"ts-canonical":        "ts-canonical",
		"thousand-sep":        "thousand-sep",
		"quoted-printable":    "quoted-printable",
		"base-norm":           "base-norm",
		"semver-norm":         "semver-norm",
		"nfkc-fold":           "nfkc-fold",
		...
		"edge-blanks":         "edge-blanks",
		"empty-headings":      "empty-headings",
		"frontmatter-strip":   "frontmatter-strip",
		"horiz-rules":         "horiz-rules",
		"html-comments":       "html-comments",
		"list-markers":        "list-markers",
		"setext-to-atx":       "setext-to-atx",
		"toc-strip":           "toc-strip",
		"unicode-lsep":        "unicode-lsep",
		"variation-sel":       "variation-sel",
	}
